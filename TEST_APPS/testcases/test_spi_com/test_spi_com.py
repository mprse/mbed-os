...
#                 {'info': 'buffers: slave RX undefined'                  , 'symbol_size': 8, 'mode': SPI_MODE_IDLE_LOW_SAMPLE_FIRST_EDGE  , 'bit_ordering': SPI_BIT_ORDERING_MSB_FIRST, 'freq_hz': 1000000   , 'master_tx_cnt': 5, 'master_rx_cnt': 5, 'slave_tx_cnt': 5, 'slave_rx_cnt': 5, 'master_tx_defined': 'true' , 'master_rx_defined': 'true' , 'slave_tx_defined': 'true' , 'slave_rx_defined': 'false', 'auto_ss': 'false', 'duplex': FULL_DUPLEX     ,'sync': 'true' },
...
class Testcase(Bench):
    ...
    def case(self):
        ...
        for tc_config in test_cases:
            print("Sub Test Case: %s" % tc_config['info'])
