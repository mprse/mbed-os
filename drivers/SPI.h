...
public:
     ...
     */
    SPI(PinName mosi, PinName miso, PinName sclk, PinName ssel, explicit_pinmap_t *explicit_pinmap);
     ...
     *  @param explicit_pinmap pointer to strucure which holds static pinmap.
     */
    SPI(PinName mosi, PinName miso, PinName sclk, PinName ssel, use_gpio_ssel_t, explicit_pinmap_t *explicit_pinmap);
