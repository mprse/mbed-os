...
/** \addtogroup hal_hardware_crc_tests */
/** @{*/
 ...
 *  is supported, false otherwise (at least on polynomial must be supported).
 *
 *  Given is platform with hardware CRC support.
 *
 *  When given polynomial is supported.
 *  Then hal_crc_is_supported() function returns true.
 *
 *  When given polynomial is not supported.
