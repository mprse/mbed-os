...
def serial_read_line(serial_port):
    ...
    while (True):
        if (serial_port.in_waiting == 0):
            ...
            limit += 1
            if (limit % 2 == 0):
                logging.debug('Waiting for transmission from target...')
            if (limit == RETRY_LIMIT):
                logging.error('No data from target.')
                sys.exit()
                break
        else:
            limit = 0
...
def wait_for_message_and_respond(serial_port, msg):
    ...
    for x in range(0, RETRY_LIMIT):
        ...
        if (line == msg):
            ...
            logging.error('Invalid data recived.')
            sys.exit()
...
def main():
    ...
    message_list = ['Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-Test message-1-\0',
                    'Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-Test message-2-\0',
                    'Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-Test message-3-\0',
                    'Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-Test message-4-\0',
                    'Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-Test message-5-\0',
                    'Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-Test message-6-\0',
                    'Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-Test message-7-\0',
                    'Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-Test message-8-\0',
                    'Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-Test message-9-\0',
                    'Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-Test message-10-\0',
                    'PASSED\0']
    ...
    parser.add_argument("-r", "--run_only", action='store_true', help="Run test only(target already flashed).", default=0)
    ...
    logging.info('Perform the following steps: \n'
                 ...
                 '3. Press the reset button on the mbed board to start the program.\n')
